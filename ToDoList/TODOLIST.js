...
$(function () {
  ...
  $("#save").click("submit", function () {
    ...
    console.log(field2);
    //ADD New
    var data = `<tr id='${field1}'><td>
      <button onClick='deleteRow("${field1}")' class="btn btn-danger">&nbsp;Delete&nbsp;</button>
      <button type="submit" onClick='editRow("${field1}")' class="btn btn-primary">&nbsp;&nbsp;&nbsp;Edit&nbsp;&nbsp;&nbsp;</button>
      </td>
      <td>${field1}
      </td>
      <td>
